  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="w-full flex flex-col gap-3.5 items-center">
        <h3 className="text-mist-200 text-4xl md:text-7xl font-extrabold tracking-widest">
          A Platform Built
        </h3>
        <ReactTyped
          className="text-mist-400 text-xl md:text-2xl font-extrabold"
          strings={[
            "by the community",
            "for the community",
      ...
      <section className="flex flex-col items-center py-20 gap-8 p-7">
        <ReactTyped
          className="text-mist-200 text-2xl md:text-4xl font-extrabold"
          strings={["Built for Every Step of Your Career Journey"]}
          typeSpeed={40}
          backSpeed={50}
          loop
        />
